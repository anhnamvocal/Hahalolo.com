            ...
            <div class="row">
                ...
                <div class="Form mt-2 col-md-6">
                    ...
                    <form class="form-inline" action="process-login.php" method="post">
                        ...
                        <div class="text-form">
                            <div class="mt-4">
                               <p>Bằng cách nhấp vào Đăng ký, bạn đồng ý với <a href="">Điều khoản dịch vụ</a>, <a href="">Chính sách dữ liệu</a>, <a href="">Chính sách cookie</a>  và <a href="">Tiêu chuẩn cộng đồng của chúng tôi</a> </p>
                            </div>
                            <div class="mt-3">
                                Bạn đã có tài khoản?
